            ...
            <div id="pendientes" class="col s12">
              <table ng-table="tabla" class="table m-t-lg" show-filter="true">
                <tr ng-repeat="(index,aux) in $data" ng-if='aux.estado==1'>
                  ...
                  <td width="10%" data-title="'Inicio'" sortable="'fecha_inicio'">
                    @{{ aux.fecha_inicio }}
                  </td>
                  <td width="18%" data-title="'Fin'" sortable="'fecha_fin'">
                    @{{ aux.fecha_fin }}
                  </td>
                  <td width="17%" data-title="'Hotel'" sortable="'hotel'">
                    @{{aux.hotel}}
                  </td>
                  ...
                  <td width="15%" data-title="'Opciones'">
                    <a ng-click="ver(aux.id)" class="cyan-text text-darken-1 m-r-sm tooltipped" data-position="top"
                      data-tooltip="Ver reserva">
                      <i class="material-icons">receipt</i>
                    </a>

                    <a ng-click="procesar(aux.id)" class="green-text text-darken-1 m-r-sm tooltipped"
                      data-position="top" data-tooltip="Procesar reserva">
                      <i class="material-icons">check</i>
                    </a>
                    <a ng-click="cancelar(aux.id)" class="red-text tooltipped" data-position="top"
...
<div id="ver" class="modal modal-fixed-footer">
  <div class="modal-content">
    <div class="row">
      ...
      <h5 class="col s12 center-align cyan-text">Datos del Hotel</h5>
...
<script>
  ...
  app.controller('ctrl', function ($scope, $http, $timeout, NgTableParams) {
    ...
    $scope.getIndex = function (id) {
      ...
      var index = reservas.map(function (e) {
        return e.id;
      }).indexOf(id);
      return index;
    }
