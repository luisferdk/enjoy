    ...
    <div id="ver" class="modal modal-fixed-footer">
            <div class="modal-content">
                <div class="row">
                    ...
                    <h5 class="col s12 center-align cyan-text">Datos del Vuelo</h5>
        ...
        app.controller('ctrl', function ($scope,$http,$timeout,NgTableParams) {
            ...
            $scope.procesar = function(id){
                swal({   
                    ...
                    $http.put('{{ url("/api/flight") }}/'+id,{_token:'{{ csrf_token() }}',estado:2})
            ...
            $scope.cancelar = function(id){
                swal({   
                    ...
                    $http.put('{{ url("/api/flight") }}/'+id,{_token:'{{ csrf_token() }}',estado:3})
                    .then(function(response){
                        $scope.index = $scope.getIndex(id);
                        $scope.reservas[$scope.index] = response.data;
                        $scope.tabla.reload();
