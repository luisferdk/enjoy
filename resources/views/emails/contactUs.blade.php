		...
		<td align="center" valign="top">
			<img height="100px" src="{{ asset('img/logo.png') }}" alt="" />
				<table>
					...
					<tr>
						<td style="color:#0086ca;width:50%;padding-right:5px;text-align:right;">Name:</td>
						<td style="width:50%;">{{ $data["name"] }}<td>
					</tr>
					<tr>
						<td style="color:#0086ca;width:50%;padding-right:5px;text-align:right;">Email:</td>
						<td style="width:50%;">{{ $data["email"] }}<td>
					</tr>
					<tr>
						<td style="color:#0086ca;width:50%;padding-right:5px;text-align:right;">Subject:</td>
						<td style="width:50%;">{{ $data["subject"] }}<td>
                    </tr>
                    <tr>
                        <td style="color:#0086ca;width:50%;padding-right:5px;text-align:right;">Message:</td>
