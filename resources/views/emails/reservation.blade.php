    ...
    <tr>
      <td align="center" valign="top">
        ...
        <table>
          ...
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">First Name:</td>
            <td style="width:50%;">{{ $reservation->nombre }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Last Name:</td>
            <td style="width:50%;">{{ $reservation->apellido }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Email:</td>
            <td style="width:50%;">{{ $reservation->correo }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Phone:</td>
            <td>{{ $reservation->telefono }}
            <td>
          </tr>
          @if($reservation->hotel!==null)
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Hotel:</td>
            <td>{{ $reservation->hotel }}
            <td>
          </tr>
          @endif
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Price:</td>
            <td>$ {{ $reservation->precio }}
            <td>
          </tr>
          <!--tr>
        ...
        <table>
          ...
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Date:</td>
            <td style="width:50%;">{{ $transfer->salida_fecha }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Hour:</td>
            <td style="width:50%;">{{ $transfer->salida_hora }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Aeroline:</td>
            <td style="width:50%;">{{ $transfer->salida_aerolinea }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Travel</td>
            <td style="width:50%;">{{ $transfer->salida_vuelo }}
            <td>
          </tr>
          @endif
        </table>
        ...
        <table>
          ...
          <tr>
            ...
            <td style="width:50%;">{{ $vip->pasajeros }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Price:</td>
          ...
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Date:</td>
            <td style="width:50%;">{{ $vip->llegada_fecha }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Hour:</td>
            <td style="width:50%;">{{ $vip->llegada_hora }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Aeroline:</td>
            <td style="width:50%;">{{ $vip->llegada_aerolinea }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Travel:</td>
            <td style="width:50%;">{{ $vip->llegada_vuelo }}
            <td>
          </tr>
          @endif
          ...
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Date:</td>
            <td style="width:50%;">{{ $vip->salida_fecha }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Hour:</td>
            <td style="width:50%;">{{ $vip->salida_hora }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Aeroline:</td>
            <td style="width:50%;">{{ $vip->salida_aerolinea }}
            <td>
          </tr>
          <tr>
            <td style="color:#2ca7b0;width:50%;padding-right:5px;text-align:right;">Travel:</td>
            <td style="width:50%;">{{ $vip->salida_vuelo }}
            <td>
          </tr>
          @endif
        </table>
