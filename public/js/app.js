...
/*------------------------------Tours------------------------------*/
  ...
  var tours = [
      ...
      },
      {
          ...
          descripcion:`In our modern boats with the latest technology skills they will provide unforgettable moments of this exciting sport. You can rent a Premium fishing boat with up to 6 people fishing and 2 companions watching.`,
          modalidades:[
          ...
          descripcion:`
              <p>
                 <strong>ZipLine</strong>
                  ...
                  On this 5 hour guided tour aboard a safari—style truck, you'll also explore the habitat's on—site botanical garden, as well as a coffee and cacao plantation. Chat it up with local farmers, learn about their organic methods and taste tropical fruit just plucked from a tree.
              </p>
          `,
          modalidades:[
      ...
      },
      {
          ...
          descripcion:`
              <p>
                  ...
                  You’ll have a spectacular view of the entire caribbean coast while getting to know the hotels of the area. While onboard you’ll enjoy different activities like; snorkel (all equipment are supplied), choreographic dancing and the warming waters of the natural pool in the middle of the ocean. A bar will be at disposal for you and your friends where you can drink all national beverages and enjoy tropical fruits and appetizers. Enjoy this excursion with the Renny Travel crew and make your vacations an unforgettable adventure. <br>
                  <br><br>
                  <strong>Jet Boat</strong>
      ...
      },
      {
          ...
          descripcion:`
              <p>
                   Experience the real thing! Yes, we have cowboys in the Dominican too! Come and live it up at our local authentic ranch, with well-kept and cared for Paso Higueyano horses. <br>
      ...
      },
      {
          ...
          mostrar:true,
          descripcion:`
              Enjoy a day of stunning reefs and beaches in Catalina Island. In this tour you will explore the "The Wall" and "Aquarium,' two reefs excellent for all levels of diving. The Wall is an impressive drop-off that stretches to the Caribbean Sea. lnhabited by corals and vibrant ﬁsh, it is a must for divers and snorkelers alike. 
              Our second dive spot, the Aquarium, is an enjoyable dive where lobster, yellow stingrays and moray eels are part of the attraction. After diving and snorkeling, you will relax with a tropical cocktail in our beach club while we prepare a delicious Dominican style barbecue. You will have free time in the afternoon to swim in the turquoise beaches of Catalina Island, enjoy unlimited drinks by the beach bar or simply relax in the sun.
          `,
          modalidades:[
